...
const changeIcon = () => {
    ...
    if(icon == 'password'){
        inputPassword.type = 'text'
        document.getElementById('btnIcon').style.background = 'url("../svg/visibility_black_24dp.svg")  center / contain no-repeat'
    }else{
        inputPassword.type = 'password'
        document.getElementById('btnIcon').style.background = 'url("../svg/visibility_off_black_24dp.svg")  center / contain no-repeat'
    }
...
const changeIconConfirm = () => {
    ...
    if(icon2 == 'password'){
        inputPasswordConfirm.type = 'text'
        document.getElementById('btnIconConfirm').style.background = 'url("../svg/visibility_black_24dp.svg")  center / contain no-repeat'
    }else{
        inputPasswordConfirm.type = 'password'
        document.getElementById('btnIconConfirm').style.background = 'url("../svg/visibility_off_black_24dp.svg")  center / contain no-repeat'
    }
